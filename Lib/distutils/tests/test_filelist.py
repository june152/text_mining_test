...
class FindAllTestCase(unittest.TestCase):
    @crawling.support.skip_unless_symlink
    def test_missing_symlink(self):
        with crawling.support.temp_cwd():
            os.symlink('foo', 'bar')
    ...
    def test_basic_discovery(self):
        ...
        with crawling.support.temp_cwd():
            ...
            crawling.support.create_empty_file(file1)
            os.mkdir('bar')
            file2 = os.path.join('bar', 'file2.txt')
            crawling.support.create_empty_file(file2)
    ...
    def test_non_local_discovery(self):
        ...
        """
        with crawling.support.temp_dir() as temp_dir:
